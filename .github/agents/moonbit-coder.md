---
name: MoonBit Coder
description: A specialized code agent for working with MoonBit code.
---
...
- When refactoring code, try to keep deprecated blocks in file called
  `deprecated.mbt` in each directory/package.

- When adding new features to the repo, try to keep type definitions in a
  `types.mbt` in each directory/package.
